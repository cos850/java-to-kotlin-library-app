...
class BookServiceTest @Autowired constructor(
    ...
    fun loanBookTest(){
        ...
        val request = BookLoanRequest("홍길동", "클린코드")
    ...
    @Test
    @DisplayName("택이 진작 대출되어 있다면, 신규 대출이 실패한다")
    fun loanBookFailTest() {
        // given
        bookRepository.save(Book("클린코드"))
        val savedUser = userRepository.save(User("홍길동", null))
        userLoanHistoryRepository.save(UserLoanHistory(savedUser, "클린코드", false))
        val request = BookLoanRequest("홍길동", "클린코드")
    ...
    fun returnBookTest(){
        ...
        val savedUser = userRepository.save(User("홍길동", null))
        userLoanHistoryRepository.save(UserLoanHistory(savedUser, "클린코드", false))
        val request = BookReturnRequest("홍길동", "클린코드")
